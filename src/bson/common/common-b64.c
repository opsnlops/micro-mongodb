...
/* micro-mongodb: arm-none-eabi/RISC-V freestanding has no pthread. Use the
 * same single-flag once primitive as common-thread-private.h. */
typedef int mongoc_common_once_t;
#define MONGOC_COMMON_ONCE_INIT 0
#define MONGOC_COMMON_ONCE_FUN(n) void n (void)
#define MONGOC_COMMON_ONCE_RETURN return
#define mongoc_common_once(o, c)                              \
   do {                                                       \
      if (*(volatile mongoc_common_once_t *) (o) == 0) {      \
         (c) ();                                              \
         *(volatile mongoc_common_once_t *) (o) = 1;          \
      }                                                       \
   } while (0)
